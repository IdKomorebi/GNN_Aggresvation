...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation16 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation16/outputs_general_gat")
