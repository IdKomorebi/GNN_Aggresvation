...
def _save_hybrid_diagnostics(
    ...
    """保存DNN16混合聚合的alpha、prior、gate诊断。"""
    ...
    print(f"  DNN16混合聚合诊断已保存至: {diag_dir}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DNN_Aggresvation16: General-GAT edge-prior pipeline"
    )
    parser.add_argument(
        "--config",
    ...
    print("\n" + "=" * 60)
    print("  DNN_Aggresvation16: General-GAT edge-prior aggregation")
    print("=" * 60)
