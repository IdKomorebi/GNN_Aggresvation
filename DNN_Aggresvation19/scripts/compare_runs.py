...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation19 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation19/outputs_difficulty")
