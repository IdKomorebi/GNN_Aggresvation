...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation20 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation20/outputs_source_expand")
    ...
    for summary_path in sorted(output_root.glob("run_*/results/summary.json")):
        ...
        row = {
            ...
            "target_loss_weighting": summary.get("target_loss_weighting"),
        }
