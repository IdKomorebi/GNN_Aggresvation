...
matched its accuracy (slightly better on set values, worse on amplification), at one to two orders of magnitude more time per set; such a model is a natural candidate for the
attacker family itself.
