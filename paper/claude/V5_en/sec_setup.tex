...
objectives are compared on the same sets with three further backbones per data set: masks restricted to small visible
sets, masked reconstruction of all candidate columns, and both.
