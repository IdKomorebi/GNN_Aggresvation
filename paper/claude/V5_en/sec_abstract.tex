...
13--17\% of the critical fields, whereas scan--certify recovers up to 88\% without false positives.
We also find that masked pre-training on the targets alone collapses the representation and, on the
small sets of an audit, adds little over random features; masked reconstruction of all columns with a safeguard against
exploding predictions improves every accuracy metric.
\end{abstract}
