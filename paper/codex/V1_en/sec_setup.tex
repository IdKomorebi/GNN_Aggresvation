...
Table~\ref{tab:data} summarizes the four data sets and ten sensitive targets. Candidate and target roles follow the categories and release timings used in the disclosure-based audit~\cite{nea2024disclosure}: candidates include forecasts, prices, and operating requirements; targets include unit outputs, an internal line flow, and actual operating quantities. These roles define a common evaluation setting across data sets. Release timing determines the field roles, while the train/test splits are random.
...
Unit output is public in the NEM but is specific information under the Chinese rules; this provides measured unit-output targets for the specified audit setting.
...
which predict the same physical quantity as the target (Section~\ref{sec:problem}). Related but distinct
...
\toprule
Data set & Sensitive targets & $n$ & $p$ & sets & max size \\
\midrule
RTS-GMLC & Unit 223, unit 221, line C35 & 6149/2635 & 23 & 10,902 & 4\\
NEM 2024 & Units BW01, TUMUT3, PPCCGT & 6149/2635 & 30 & 31,930 & 4\\
PJM (load) & Metered load & 4589/1967 & 22 & 9,108 & 4\\
PJM (gen./interch.) & Total generation, net interchange & 4589/1967 & 24 & 12,950 & 4\\
CAISO & Actual load & 6105/2617 & 35 & 59,535 & 4\\
\bottomrule
\end{tabular}}
\end{table*}
...
124,425 field sets and several hundred thousand trained models. The amortized estimator is fitted without these retrained reference values.
