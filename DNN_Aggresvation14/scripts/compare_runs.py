...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation14 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation14/outputs")
