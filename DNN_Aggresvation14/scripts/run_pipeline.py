...
def _save_hybrid_diagnostics(
    ...
    """保存DNN14混合聚合的alpha、prior、gate诊断。"""
    ...
    print(f"  DNN14混合聚合诊断已保存至: {diag_dir}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DNN_Aggresvation14: DNN13-based weak-target tuning pipeline"
    )
    parser.add_argument(
        "--config",
    ...
    print("\n" + "=" * 60)
    print("  DNN_Aggresvation14: DNN13-based weak-target tuning")
    print("=" * 60)
