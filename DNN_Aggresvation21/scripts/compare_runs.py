...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation21 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation21/outputs_temporal")
