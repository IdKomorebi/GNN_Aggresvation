...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation25 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation27/outputs_multihead")
