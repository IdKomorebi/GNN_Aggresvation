# -*- coding: utf-8 -*-
"""【125 号派生自 124 号 profile124.py，唯一改动：估计器换为 125 号固定的新估计器（registry125）、输出到 outputs/d124】
...
sys.path.insert(0, os.path.join(ROOT, "src")); import registry125 as registry  # noqa: E402
A = os.path.join(ROOT, "outputs", os.environ.get("OUT125", "d124")); os.makedirs(A, exist_ok=True)
rows, ctx, dist = [], [], []
