# -*- coding: utf-8 -*-
"""【125 号派生自 117 号 analyze117.py，唯一改动：估计器换为 125 号固定的新估计器（registry125）、输出到 outputs/d117】
...
ROOT = os.path.join(os.path.dirname(HERE), "DNN_Aggresvation117")   # 基线打分 scores_*.csv 仍取自 117 号
sys.path.insert(0, os.path.join(HERE, "src")); import registry125 as registry  # noqa: E402
sys.path.insert(0, os.path.join(ROOT, "..", "DNN_Aggresvation111", "src")); import pipe  # noqa: E402
AN = os.path.join(HERE, "outputs", os.environ.get("OUT125", "d117")); os.makedirs(AN, exist_ok=True)
