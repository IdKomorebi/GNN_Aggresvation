...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation26 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation26/outputs_staged_phase")
