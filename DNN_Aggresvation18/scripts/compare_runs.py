...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation18 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation18/outputs_uncertainty")
