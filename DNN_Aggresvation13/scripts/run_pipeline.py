...
def _save_hybrid_diagnostics(
    ...
    """保存DNN13混合聚合的alpha、prior、gate诊断。"""
    ...
    print(f"  DNN13混合聚合诊断已保存至: {diag_dir}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DNN_Aggresvation13: confidential-edge-alpha hybrid gated prior GAT 推断驱动敏感度评估流水线"
    )
    parser.add_argument(
        "--config",
    ...
    print("\n" + "=" * 60)
    print("  DNN_Aggresvation13: confidential-edge-alpha hybrid gated prior GAT 推断驱动敏感度评估")
    print("=" * 60)
