...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation13 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation13/outputs")
