...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation23 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation23/outputs_temporal4")
