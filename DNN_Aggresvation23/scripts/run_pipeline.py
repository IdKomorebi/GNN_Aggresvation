...
def _save_hybrid_diagnostics(
    ...
    """保存DNN23混合聚合的alpha、prior、gate诊断。"""
    ...
    print(f"  DNN23混合聚合诊断已保存至: {diag_dir}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DNN_Aggresvation23: window_size=4 temporal input pipeline"
    )
    parser.add_argument(
        "--config",
    ...
    print("\n" + "=" * 60)
    print("  DNN_Aggresvation23: window_size=4 temporal input")
    print("=" * 60)
