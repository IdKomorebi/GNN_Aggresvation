...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation9 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation9/outputs")
