...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation8 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation8/outputs")
