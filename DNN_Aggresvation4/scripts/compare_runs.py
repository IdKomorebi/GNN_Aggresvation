...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation4 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation4/outputs")
