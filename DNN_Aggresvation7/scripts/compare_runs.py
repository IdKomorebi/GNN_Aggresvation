...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation7 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation7/outputs")
