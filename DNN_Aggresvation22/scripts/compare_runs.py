...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation22 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation22/outputs_temporal6")
