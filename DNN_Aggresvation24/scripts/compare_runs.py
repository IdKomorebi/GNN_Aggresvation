...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation24 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation24/outputs_temporal_mlp")
