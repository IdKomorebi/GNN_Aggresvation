...
def _save_hybrid_diagnostics(
    ...
    """保存DNN24混合聚合的alpha、prior、gate诊断。"""
    ...
    print(f"  DNN24混合聚合诊断已保存至: {diag_dir}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DNN_Aggresvation24: temporal MLP encoder pipeline"
    )
    parser.add_argument(
        "--config",
    ...
    print("\n" + "=" * 60)
    print("  DNN_Aggresvation24: temporal MLP encoder")
    print("=" * 60)
