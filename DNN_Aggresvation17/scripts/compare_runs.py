...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation17 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation17/outputs_residual_expert")
