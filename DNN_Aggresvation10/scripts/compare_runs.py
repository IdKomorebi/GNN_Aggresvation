...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation10 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation10/outputs")
