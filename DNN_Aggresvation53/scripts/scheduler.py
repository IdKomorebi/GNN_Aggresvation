#!/usr/bin/env python3
"""DNN53 调度器：经典(加性)GAT × 3 编码 × 3 GAT 模式 = 9 个训练，4 GPU 并行。"""
import os, subprocess, time
from collections import deque
from pathlib import Path

D = Path("/data1/duhaocun/projects/GNN_Aggresvation/DNN_Aggresvation53")
...
print(f"DNN53 调度器：{len(jobs)} 个任务(经典 GAT)，{len(GPUS)} 卡\n")
while jobs and pool:
