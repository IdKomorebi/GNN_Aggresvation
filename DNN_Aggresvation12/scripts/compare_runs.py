...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation12 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation12/outputs")
