#!/usr/bin/env python3
"""DNN40 调度器：4 GPU 并行跑 13 个 fixed-info GNN run（1 multi + 12 single）。
...
D32 = Path("/data1/duhaocun/projects/GNN_Aggresvation/DNN_Aggresvation40_InterimSummary")
...
print(f"DNN40 调度器：{len(configs)} 个任务，{len(GPUS)} 张 GPU")
