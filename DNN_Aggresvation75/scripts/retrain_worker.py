...
# DNN75：复制自 67 号，只改路径头——src/ 与相关性张量、CSV 取自 69 号（保持真值口径一致），
# base.yaml / subsets.json / outputs 落在 75 号自己的目录。其余代码一字未动。
ROOT = Path(__file__).resolve().parent.parent          # = DNN_Aggresvation75
