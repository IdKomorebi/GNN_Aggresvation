...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation11 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation11/outputs")
