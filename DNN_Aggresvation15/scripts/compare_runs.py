...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare DNN_Aggresvation15 runs")
    parser.add_argument("--outputs", default="DNN_Aggresvation15/outputs_adaptive")
