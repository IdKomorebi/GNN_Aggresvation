...
def _save_hybrid_diagnostics(
    ...
    """保存DNN15混合聚合的alpha、prior、gate诊断。"""
    ...
    print(f"  DNN15混合聚合诊断已保存至: {diag_dir}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DNN_Aggresvation15: adaptive threshold-topk edge pipeline"
    )
    parser.add_argument(
        "--config",
    ...
    print("\n" + "=" * 60)
    print("  DNN_Aggresvation15: adaptive min/max edge selection")
    print("=" * 60)
